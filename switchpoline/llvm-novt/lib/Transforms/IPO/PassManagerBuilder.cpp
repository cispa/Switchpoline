...
void PassManagerBuilder::populateLTOPassManager(legacy::PassManagerBase &PM) {
  ...
  PM.add(new NoICLibraryFixesLegacyPass(false));
  if (typegraph::Settings.novt_enabled)
    PM.add(new NoVTAbiBuilderLegacyPass());
  PM.add(createGlobalDCEPass());
  if (typegraph::Settings.noic_enabled)
    PM.add(new NoICAbiBuilderLegacyPass());
  PM.add(new NoICLibraryFixesLegacyPass(true));
  if (typegraph::Settings.novt_enabled)
  ...
  if (typegraph::Settings.enabled)
    PM.add(new NoICFinalCheckLegacyPass());
}

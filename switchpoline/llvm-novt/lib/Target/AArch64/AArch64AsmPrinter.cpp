...
void AArch64AsmPrinter::EmitInstruction(const MachineInstr *MI) {
  ...
  case AArch64::TLSDESC_CALLSEQ: {
    ...
    if (typegraph::Settings.enforce_jit) {
      // MOD HERE FOR JIT
      auto *JitSymbol = this->OutContext.getOrCreateSymbol("__noic_default_handler_for_tlsdesc");
      EmitToStreamer(*OutStreamer, MCInstBuilder(AArch64::BL).addExpr(MCSymbolRefExpr::create(JitSymbol, OutContext)));
